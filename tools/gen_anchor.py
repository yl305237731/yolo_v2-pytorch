...
import argparse
import numpy as np
from tools.util import parse_voc_annotation
...
def gen_anchors(annos_path, imgs_path, num_anchors):
...
if __name__ == '__main__':
    annos_path = args.annos_dir
    imgs_path = args.imgs_dir
    anchor_num = args.anchor_num
    gen_anchors(annos_path, imgs_path, anchor_num)